...
DEFAULT_GPT2_SYSTEM = (
    ...
    '- MEDIUM (news/commercial): Treat as standard evidence.\n'
    '- LOW (unknown/spam): Treat with extreme skepticism. A claim supported ONLY by LOW trust sources must receive a "Low Trust Source" soft violation.\n\n'
